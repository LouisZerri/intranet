                            ...
                            <div class="relative">
                                <select name="localisation" 
                                    ...
                                    @foreach($departementsFrancais as $dept)
                                        <option value="{{ $dept }}" {{ old('localisation') === $dept ? 'selected' : '' }}>
                                            {{ $dept }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('professional_address') }}"
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('professional_postal_code') }}"
                                   placeholder="75001"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="legal_mentions" 
                                      ...
                                      class="block w-full px-3 py-2.5 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors @error('legal_mentions') border-red-300 ring-red-500 @enderror">{{ old('legal_mentions') }}</textarea>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="footer_text" 
                                      ...
                                      class="block w-full px-3 py-2.5 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors @error('footer_text') border-red-300 ring-red-500 @enderror">{{ old('footer_text') }}</textarea>
                            @error('footer_text')
                                <p class="mt-2 text-sm text-red-600 flex items-center">
                                    <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
            ...
            <div class="ml-3">
                ...
                <div class="mt-2 text-sm text-blue-700">
                    <ul class="list-disc list-inside space-y-1">
                        <li>Choisissez un mot de passe sécurisé d'au moins 8 caractères</li>
                        <li>L'utilisateur recevra ses identifiants par email après création</li>
                        <li>Un collaborateur peut être assigné à un manager pour le suivi</li>
