...
@section('title', 'Créer une actualité - Intranet')
...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="bg-white shadow rounded-lg">
        <div class="p-6 border-b border-gray-200">
            <h1 class="text-2xl font-bold text-gray-900">✍️ Créer une nouvelle actualité</h1>
            <p class="text-gray-600 mt-1">
                @if(auth()->user()->isManager())
                    Partagez des informations importantes avec votre équipe
                @else
                    Partagez des informations importantes avec vos collaborateurs
                @endif
            </p>
        </div>

        <form method="POST" action="{{ route('news.store') }}" class="p-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                <div class="relative">
                    <input type="text" 
                           ...
                           placeholder="Ex: 🚨 Nouvelle procédure de sécurité mise en place">
            ...
            <div>
                ...
                <div class="relative">
                    <textarea id="content" 
                              ...
                              placeholder="Rédigez le contenu complet de votre actualité...&#10;&#10;💡 Conseils :&#10;• Soyez clair et précis&#10;• Utilisez des paragraphes pour la lisibilité&#10;• Ajoutez des emojis pour plus d'impact">{{ old('content') }}</textarea>
                ...
                <p class="mt-2 text-sm text-gray-500 flex items-center">
                    ...
                    Le contenu sera affiché tel que saisi. Utilisez des retours à la ligne pour les paragraphes.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        <select id="priority" 
                            ...
                            <option value="" class="text-gray-400">Choisir une priorité...</option>
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500 flex items-center">
                        ...
                        L'actualité sera automatiquement masquée après cette date
                    </p>
                </div>
            </div>
                ...
                <div class="border-t border-gray-200 pt-6">
                    <div class="bg-gray-50 -m-6 p-6 rounded-t-lg">
                        ...
                        <p class="text-sm text-gray-600">
                            Définissez qui peut voir cette actualité. Si aucune sélection n'est faite, elle sera visible par tous les collaborateurs.
                        </p>
                    </div>
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
                    <div class="flex items-center p-4 bg-blue-50 border border-blue-200 rounded-lg">
                        <input type="checkbox" 
                               ...
                               class="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500 focus:ring-2">
                        <label for="publish_now" class="ml-3 flex items-center cursor-pointer">
                            <svg class="w-5 h-5 mr-2 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8"/>
                            </svg>
                            <div>
                                <div class="text-sm font-medium text-blue-900">📤 Publier immédiatement</div>
                                <div class="text-xs text-blue-700">L'actualité sera visible dès la création</div>
                            </div>
                        </label>
                    </div>
...
document.getElementById('title').addEventListener('input', function() {
    ...
    counter.className = currentLength > maxLength ? 'mt-1 text-sm text-red-600' : 'mt-1 text-sm text-gray-500';
});
</script>
@endsection