...
@section('title', 'Créer un produit - Communication')
...
<div class="max-w-3xl mx-auto space-y-6">
    ...
    <div class="flex items-center space-x-4">
        ...
        <div>
            ...
            <p class="text-gray-600 mt-1">Ajoutez un produit au catalogue de communication</p>
        </div>
    </div>

    <!-- Formulaire -->
    <div class="bg-white shadow rounded-lg">
        <form action="{{ route('admin.communication.products.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                <div class="mt-1 flex items-center space-x-4">
                    <div id="image-preview" class="hidden">
                        <img id="preview-img" src="" alt="Aperçu" class="h-32 w-32 object-cover rounded-lg border-2 border-gray-300">
                    </div>
