...
@section('content')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="date" name="validity_date" id="validity_date"
                                    value="{{ old('validity_date', isset($quote) && $quote->validity_date ? $quote->validity_date->format('Y-m-d') : now()->addMonth()->format('Y-m-d')) }}"
    ...
    <script>
        ...
        function addEDLToQuote() {
            ...
            message.textContent = '✅ État des lieux ajouté au devis (Type: Location)';
