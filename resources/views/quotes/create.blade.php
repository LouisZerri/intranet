    ...
    <div class="space-y-6">
        ...
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">Créez un devis pour votre client</p>
            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select name="revenue_type" id="revenue_type" required
                                    ...
                                    <option value="transaction" {{ old('revenue_type', 'transaction') === 'transaction' ? 'selected' : '' }}>
                                        🏠 Transaction (Vente)
                                    </option>
                                    <option value="location" {{ old('revenue_type') === 'location' ? 'selected' : '' }}>
                                        🔑 Location (Gestion locative)
                                    </option>
                                    <option value="syndic" {{ old('revenue_type') === 'syndic' ? 'selected' : '' }}>
                                        🏢 Syndic (Copropriété)
                                    </option>
                                    <option value="autres" {{ old('revenue_type') === 'autres' ? 'selected' : '' }}>
                                        📋 Autres
                                    </option>
                                </select>
                                @error('revenue_type')
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-xs text-gray-500">Par défaut : 30 jours</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea name="client_notes" id="client_notes" rows="3"
                                    class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500"
                                    placeholder="Notes qui apparaîtront sur le devis...">{{ old('client_notes') }}</textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="payment_terms" id="payment_terms"
                                    value="{{ old('payment_terms', 'Paiement à 30 jours fin de mois') }}"
                                    class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500">
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="internal_notes" id="internal_notes" rows="2"
                                    class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500"
                                    placeholder="Notes internes pour votre équipe...">{{ old('internal_notes') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:col-span-1 space-y-4">
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                        ...
                        <ul class="space-y-2 text-sm text-blue-800">
                            ...
                            <li>• Le devis sera créé en brouillon</li>
                        </ul>
                    </div>
