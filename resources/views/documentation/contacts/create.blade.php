    ...
    <div class="space-y-6">
        ...
        <div class="bg-white shadow rounded-lg p-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">➕ Ajouter un contact</h1>
                    <p class="text-gray-600 mt-1">Créer un nouveau contact dans l'annuaire</p>
                </div>
                                ...
                                <div class="relative">
                                    <select name="sector" id="sector"
                                        ...
                                        <option value="commercial" {{ old('sector') === 'commercial' ? 'selected' : '' }}>
                                            🏢 Commercial</option>
                                        <option value="technique" {{ old('sector') === 'technique' ? 'selected' : '' }}>🔧
                                            Technique</option>
                                        <option value="juridique" {{ old('sector') === 'juridique' ? 'selected' : '' }}>⚖️
                                            Juridique</option>
                                        <option value="rh" {{ old('sector') === 'rh' ? 'selected' : '' }}>👥
                                            Ressources Humaines</option>
                                        <option value="finance" {{ old('sector') === 'finance' ? 'selected' : '' }}>💰
                                            Finance</option>
                                        <option value="it" {{ old('sector') === 'it' ? 'selected' : '' }}>💻
                                            Informatique</option>
                                    </select>
                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                        <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor"
                                ...
                                <div class="relative">
                                    <select name="is_active" id="is_active"
                                        ...
                                        <option value="1" {{ old('is_active', '1') === '1' ? 'selected' : '' }}>✅
                                            Actif</option>
                                        <option value="0" {{ old('is_active') === '0' ? 'selected' : '' }}>❌ Inactif
                                        </option>
                                    </select>
                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                        <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor"
                ...
                <div class="ml-3">
                    ...
                    <div class="mt-2 text-sm text-blue-700">
                        <ul class="list-disc list-inside space-y-1">
                            ...
                            <li>Les contacts inactifs n'apparaîtront pas dans les recherches</li>
